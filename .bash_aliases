...
alias pstorm="$(find ${user_home}/jetbrains/PhpStorm*/bin -type f -name phpstorm)";
...
# Using sed (with explicit null terminator (most robust)) in the alias, to remove trailing newline
